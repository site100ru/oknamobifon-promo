...
<body
    ...
    <main class="site-main">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="section-glazing__item">
                            ...
                            <p class="price">Цена: от 7 500 руб. м. кв.</p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="section-glazing__item">
                            ...
                            <p class="price">Цена: от 11 500 руб. м. кв.</p>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="section-glazing__item">
                            ...
                            <p class="price">Цена: от 25 500 руб. м. кв.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="section section-promo-products section-quality bg-white pb-5">
            <div class="container">
                <h2 class="section__title section-uso__title">Установка <span>окон</span></h2>
                <p class="section__subtitle section-products__subtitle mb-1"
                    style="max-width: 70%; width: 100%; text-wrap: auto">
                    Одним из основных факторов качественного остекления является монтаж окон. При неправильном монтаже, даже после установки самых дорогих и качественных окон могут быть проблемы.
                </p>

                <h2 class="section__title section-uso__title mb-5"><span>Мы гарантируем своим клиентам:</span></h2>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xl-6 mb-4 mb-lg-0">
                        ...
                        <div class="row pt-3">
                            <div class="col text-start">
                                <p class="mb-0">Монтаж строго по ГОСТу.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-6 mb-4 mb-lg-0">
                        ...
                        <div class="row pt-3">
                            <div class="col text-start">
                                <p class="mb-0">Использование только качественных материалов.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-6 mb-4 mb-lg-0">
                        ...
                        <div class="row pt-3">
                            <div class="col text-start">
                                <p class="mb-0">Отсутствие продувания и протекания.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-6 mb-4 mb-lg-0">
                        ...
                        <div class="row pt-3">
                            <div class="col text-start">
                                <p class="mb-0">Отсутствие запотевания, плесени и грибка.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col nav-scroller">
                        <ul class="nav d-flex m-auto mb-3 mb-md-5" id="worksTab" role="tablist">
                            ...
                            <li class="nav-item d-none d-xl-inline">
                                <span class="nav-link px-0">
                                    <svg style="margin-bottom: 5px;" width="6" height="6" viewBox="0 0 6 6" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="svg-icon">
                                        <rect width="6" height="6" rx="2"></rect>
                                    </svg>
                                </span>
                            </li>
                            <li class="nav-item nav-item-tab" role="presentation">
                            ...
                            <li class="nav-item nav-item-tab" role="presentation">
                                <button class="nav-link" id="balconies-loggias-tab" data-bs-toggle="tab" data-bs-target="#balconies-loggias" type="button" role="tab">
                                    Балконы/Лоджии
                                </button>
                            </li>
                            <li class="nav-item d-none d-xl-inline">
                            ...
                            <li class="nav-item nav-item-tab" role="presentation">
                                <button class="nav-link" id="spa-tab" data-bs-toggle="tab" data-bs-target="#spa" type="button" role="tab">
                                    СПА
                                </button>
                            </li>
                            <li class="nav-item d-none d-xl-inline">
                            ...
                            <li class="nav-item nav-item-tab" role="presentation">
                                <button class="nav-link" id="pavilions-tab" data-bs-toggle="tab" data-bs-target="#pavilions" type="button" role="tab">
                                    Беседки
                                </button>
                            </li>
                            <li class="nav-item d-none d-xl-inline">
                            ...
                            <li class="nav-item nav-item-tab" role="presentation">
                                <button class="nav-link" id="cottages-tab" data-bs-toggle="tab" data-bs-target="#cottages" type="button" role="tab">
                                    Коттеджи
                                </button>
                            </li>
                            <li class="nav-item d-none d-xl-inline">
                            ...
                            <li class="nav-item nav-item-tab" role="presentation">
                                <button class="nav-link" id="various-tab" data-bs-toggle="tab" data-bs-target="#various" type="button" role="tab">
                                    Другое
                                </button>
                            </li>
                        </ul>
                ...
                <div class="tab-content" id="worksTabContent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Apartments" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Apartments" data-bs-slide="next">
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление квартиры на ул. Свободы.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Остекление 3-х окон профильной системой КВЕ 70мм.</li>
                                        <li>Окна из профиля КВЕ Еbergt.</li>
                                        <li>Откосы, подоконники, отливы.</li>
                                        <li>Клапан приточной вентиляции.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 10 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость под ключ:</strong> 165 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Loggia" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Loggia" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление и отделка лоджии ул. Ангарская.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Остекление лоджии пластиковыми окнам из профиля Novotex.</li>
                                        <li>Отделка панелями ПВХ.</li>
                                        <li>Настил Пола влагостойким ламинатом.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 12 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость:</strong> 185 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Loggias" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                            <button type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide-to="9" aria-label="Slide 10"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-8.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-8.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-9.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-9.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-10.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-10.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Loggias" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление и отделка лоджии серии дома П-44 на ул.Митинская.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Остекление лоджии пластиковыми окнами Rehau 60 мм. с однокамерным стеклопакетом.</li>
                                        <li>Отделка стен и потолка пластиковой вагонкой.</li>
                                        <li>Настил Пола влагостойким ламинатом 34 класса износостойкости.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 8 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость:</strong> 155 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Balconies" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-8.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-8.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Balconies" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление, утепление и отделка лоджии на ул. шоссе Энтузиастов</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Остекление лоджии раздвижными окнами из алюминиевого профиля Provedal.</li>
                                        <li>Утепление пеноплекс 30мм.</li>
                                        <li>Отделка стен и потолка панелями ПВХ 250мм.</li>
                                        <li>Настил Пола влагостойким ламинатом 34 класса износостойкости.</li>
                                        <li>Обустройство шкафа с раздвижными дверями.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 14 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость под ключ:</strong> 189 460 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Balcony" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Balcony" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление,утепление и отделка лоджии ул. Генерала Белобородова.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Остекление лоджии из профиля КВЕ 70 мм.</li>
                                        <li>Утепление пеноплекс 50 мм.</li>
                                        <li>Отделка стен и потолка панелями ПВХ в цвет.</li>
                                        <li>Настил Пола ламинат 36 класс износостойкости</li>
                                        <li>Подоконники Кристаллит</li>
                                        <li>Шторы день-ночь подобраны в цвет.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 15 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость проекта:</strong> 275 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Spa" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                            <button type="button" data-bs-target="#carouselAll-Spa" data-bs-slide-to="9" aria-label="Slide 10"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-8.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-8.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-9.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-9.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-10.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-10.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Spa" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Spa" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление SPA в КП Ренессанс Парк Новорижское шоссе.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Окна из теплого алюминиевого профиля New Tec.</li>
                                        <li>Окраска по шкале RAL цвет 8017 коричневый.</li>
                                        <li>Стеклопакеты энергосберегающие с декоративной раскладкой под золото.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 30 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 5 дней.</p>
                                    <p><strong>Стоимость проекта:</strong> 1 540 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Pavilions" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-8.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-8.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-9.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-9.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Pavilions" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление беседки в КП Ренессанс Парк.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Окна из теплого алюминиевого профиля New Tec.</li>
                                    ...
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 20 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость проекта:</strong> 435 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Cottages" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Cottages" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong>Остекление коттеджа Шаховской район д. Афанасово.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Окна из теплого алюминия New Tec.</li>
                                        <li>Окраска по шкале RAL цвет антрацит.</li>
                                        <li>Отливы и москитные сетки.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 24 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 3 дня.</p>
                                    <p><strong>Стоимость:</strong> 750 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselAll-Various" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselAll-Various" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-1.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-2.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-2.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-3.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-3.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-4.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-4.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-5.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-5.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-6.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-6.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-7.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-7.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-8.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-8.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                            <div class="carousel-item" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-9.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                                    <div class="single-product-img approximation">
                                                        <img src="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-9.webp" class="shadow rounded d-block w-100" alt="..." loading="lazy">
                                                        <div class="magnifier"></div>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselAll-Various" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselAll-Various" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    <p class="mb-0"><strong> Замена фурнитуры на пластиковых окнах от застройщика ЖК Матвеевский парк.</strong></p>
                                    <p class="mb-0"><strong>Что сделано:</strong></p>
                                    <ul class="mb-0">
                                        <li>Замена фурнитуры Vorne от застройщика на 3 окнах.</li>
                                        <li>Установка поворотно-откидной фурнитуры ROTO NX.</li>
                                    </ul>
                                    <p class="mb-0"><strong>Срок работ:</strong> 1 день.</p>
                    ...
                    <div class="tab-pane fade" id="apartments" role="tabpanel" aria-labelledby="apartments-tab">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselApartments" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselApartments" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselApartments" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselApartments" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselApartments" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselApartments" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/apartments-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselApartments" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselApartments" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                    ...
                    <!-- Балконы/Лоджии -->
                    <div class="tab-pane fade" id="balconies-loggias" role="tabpanel" aria-labelledby="balconies-loggias-tab">
                        <div class="row">
                            <!-- Loggia -->
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselLoggia" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselLoggia" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Loggia-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselLoggia" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselLoggia" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                                ...
                                <div class="text-wrapper">
                                    ...
                                    <p class="mb-0"><strong>Срок изготовления:</strong> 12 дней.</p>
                                    <p class="mb-0"><strong>Срок монтажа:</strong> 2 дня.</p>
                                    <p><strong>Стоимость под ключ:</strong> 185 000 руб.</p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselLoggias" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                            <button type="button" data-bs-target="#carouselLoggias" data-bs-slide-to="9" aria-label="Slide 10"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/loggias-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselLoggias" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselLoggias" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselBalconies" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselBalconies" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balconies-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselBalconies" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselBalconies" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                            ...
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselBalcony" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselBalcony" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselBalcony" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselBalcony" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselBalcony" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselBalcony" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/balcony-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselBalcony" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselBalcony" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="spa" role="tabpanel" aria-labelledby="spa-tab">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselSpa" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                            <button type="button" data-bs-target="#carouselSpa" data-bs-slide-to="9" aria-label="Slide 10"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/spa-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                    ...
                    <!-- Беседки -->
                    <div class="tab-pane fade" id="pavilions" role="tabpanel" aria-labelledby="pavilions-tab">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselPavilions" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselPavilions" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/pavilion-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselPavilions" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselPavilions" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                    ...
                    <!-- Коттеджи -->
                    <div class="tab-pane fade" id="cottages" role="tabpanel" aria-labelledby="cottages-tab">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselCottages" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselCottages" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/cottage-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselCottages" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselCottages" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="various" role="tabpanel" aria-labelledby="various-tab">
                        <div class="row">
                            <div class="col-md-11">
                                <div class="gallery-grid">
                                    <div id="carouselVarious" class="carousel slide mb-3" data-bs-ride="carousel" data-bs-interval="999999999">
                                        <div class="carousel-indicators" style="bottom: 5%;">
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="1" aria-label="Slide 2"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="2" aria-label="Slide 3"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="3" aria-label="Slide 4"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="4" aria-label="Slide 5"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="5" aria-label="Slide 6"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="6" aria-label="Slide 7"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="7" aria-label="Slide 8"></button>
                                            <button type="button" data-bs-target="#carouselVarious" data-bs-slide-to="8" aria-label="Slide 9"></button>
                                        </div>
                                        <div class="carousel-inner rounded">
                                            <div class="carousel-item active" data-bs-interval="999999999">
                                                <a href="<?php echo get_template_directory_uri(); ?>/promo/img/gallery/Various-1.webp" data-pswp-width="1200" data-pswp-height="900" class="gallery-grid__item">
                                        ...
                                        <button class="carousel-control-prev" type="button" data-bs-target="#carouselVarious" data-bs-slide="prev">
                                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Назад</span>
                                        </button>
                                        <button class="carousel-control-next" type="button" data-bs-target="#carouselVarious" data-bs-slide="next">
                                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                            <span class="visually-hidden">Вперед</span>
                                        </button>
                                    </div>
